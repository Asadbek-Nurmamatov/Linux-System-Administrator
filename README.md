...
2 Yuklab oling, o'rnating va sozlang
- Oracle Virtual Box nima?
- Oracle Virtual Box-ni yuklab olish va o'rnatish
- Virtual mashina yaratish
- Linux tarqatish
- Linuxni o'rnatishning boshqa usuli
- Linuxni yuklab olish va o'rnatish (CentOS)
- Redhat Linuxni o'rnatish (ixtiyoriy)
- Linux ish stoli (GUI)
- Virtual mashina boshqaruvi
- Linux va Windows
- Linuxni kim ishlatadi?
- Viktorina, uy vazifasi va tarqatma materiallar

- 3 Tizimga kirish va fayl tizimi
- Linux tizimiga kirish
- Putty-ni yuklab oling va o'rnating
- Yangi tarmoq buyruqlari (ifconfig va ip)
- Linux VMni Putty orqali ulang
- Linuxda eslash kerak bo'lgan muhim narsalar
- Fayl tizimiga kirish
- Fayl tizimi tuzilishi tavsifi
- Fayl tizimi navigatsiya buyruqlari
- Fayl tizimi yoʻllari
- Kataloglar roʻyxatiga umumiy koʻrinish
- Fayllar va kataloglarni yaratish
- Linux fayl turlari
- Fayllar va kataloglarni topish (topish, joylashtirish)
- Find va Locate buyruqlari orasidagi farq
- Parolni o'zgartirish
- Joker belgilar (*, $, ^)
- Yumshoq va qattiq havolalar (ln)
- GUI orqali tasvir faylini qanday ochish mumkin
- Viktorina, uy vazifasi va tarqatma materiallar

4-modul – Linux asoslari
- Buyruqlar sintaksisi
- Fayl ruxsatnomalari (chmod)
- Faylga egalik (chown, chgrp)
- Yordam olish (erkak, nima va boshqalar)
- TAB-ni yakunlash va yuqoriga strelkalar
...
- CD/DVD dan mahalliy ombor yaratish
...
- Standart fayl ruxsatnomalarini o‘zgartirish (umask)
